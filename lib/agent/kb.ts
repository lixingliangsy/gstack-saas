...
export const KB: KbEntry[] = [
  {
    ...
    body:
      "GotoDeck 增长工作台是一个面向独立开发者的出海控制台，把建站、支付、合规与增长分析四件事串到一起，让你用更少时间把产品卖到更多国家。它不是单点工具，而是一套「从落地到收款到合规到增长」的工作流。",
    source: "产品文档 / 官网首页",
    tags: [],
  },
  {
    ...
    body:
      "GotoDeck 围绕四个支柱：① 建站 —— 落地页 / 博客 / SEO 一键生成，面向 AI 搜索优化；② 支付 —— Waffo 订阅接入，覆盖欧美主流市场；③ 合规 —— 出海合规 / 市场准入扫描（GDPR、VAT、消费者保护、应用商店与支付监管）；④ 增长分析 —— 用量、转化、漏斗与留存看板，指导增长决策。",
    source: "产品文档 / 功能概览",
    tags: [],
  },
  {
    ...
    body:
      "出海合规扫描是 GotoDeck 的核心 AI 工具：你输入产品 / 业务描述、目标市场、商业模式、是否处理个人数据与支付、分发渠道、用户年龄，工具输出一份结构化的「合规就绪度简报」——覆盖 GDPR / UK-GDPR / CCPA 数据义务、欧盟 / 英国 VAT 与 OSS、消费者保护（价格透明、撤回权、禁止刷评）、应用商店规则（隐私标签、IAP）、支付监管（PCI-DSS、SCA / PSD2）与跨境数据传输（SCC / 充分性认定）。规则引擎先跑、LLM 辅助解释，结论可解释、可复核。",
    source: "产品文档 / 合规扫描",
    tags: ["compliance"],
  },
  {
  ...
  },
  {
    ...
    body:
      "GotoDeck 通过 Waffo Pancake 接入订阅支付，支持欧美主流信用卡 / 支付方式，月付与年付均可。升级时在结账页选择档位与周期，跳转 Waffo 完成支付，订阅状态会自动同步到你的账户。",
    source: "产品文档 / 支付",
    tags: [],
  },
  {
  ...
  {
    id: "privacy",
    title: "GotoDeck 如何处理我的数据",
    keywords: ["隐私", "数据", "收集", "个人信息", "安全", "加密", "存储", "密码"],
    body:
      "GotoDeck 仅收集运行服务所必需的数据：账户邮箱与（哈希后的）密码、你提交的合规扫描输入、必要的用量指标。密码使用 bcrypt 哈希，密钥仅存于服务端。我们不会把你的业务数据用于训练或转售。详细以隐私政策为准。",
    source: "产品文档 / 隐私",
    tags: ["compliance"],
  },
  {
    ...
    body:
      "我是 GotoDeck 的 AI 客服助手，基于产品知识库回答关于产品、功能、定价、支付、账户与合规扫描的常见问题，并在需要时为你转接人工。我无法替代法律 / 税务 / 专业顾问意见，合规类答复仅供参考；我也不能直接修改你的账户、处理退款或访问你的支付凭证。",
    source: "产品文档 / AI 客服",
    tags: [],
  },
  {
    ...
    body:
      "关于 GDPR、VAT、消费者保护、应用商店与支付监管等话题，GotoDeck 提供的是决策辅助与信息梳理，不构成法律、税务或专业意见，也不构成「合规认证」。正式出海前请结合首要法律文本并咨询合格顾问。",
    source: "产品文档 / 合规扫描",
    tags: ["compliance"],
  },
  {
  ...
  },
  {
    ...
    body:
      "GotoDeck 提供可嵌入的客服组件：在你想加载的页面加入 <script src=\"https://你的域名/embed/chat\"></script>（或通过 /embed/chat 的 iframe），即可在任意网站显示聊天入口。组件通过 iframe 隔离样式，跨站安全。具体 host 以你的部署域名为准。",
    source: "产品文档 / 嵌入",
    tags: [],
  },
  {
