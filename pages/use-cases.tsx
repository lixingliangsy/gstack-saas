...
export default function Page() {
  return (
    <>
      <Head>
        <title>GStack — Use cases</title>
        <meta name="description" content="How indie founders, agencies, and SMB growth teams use GStack to go global with a single growth console." />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">GStack is built for teams that need a growth console without the overhead of a BI platform.</p>

          <div className="mt-10 space-y-10">
            <section>
              <h2 className="text-xl font-semibold text-slate-900">Indie founders</h2>
              <p className="mt-3 text-sm text-slate-600">
                Solo bootstrappers use GStack to replace three or four dashboards — Stripe, Plausible, App Store Connect, Google Analytics — with a single console that shows revenue, traction, and funnel health at a glance.
              </p>
            ...
            <section>
              ...
              <p className="mt-3 text-sm text-slate-600">
                Agencies managing 5–50 client accounts use GStack to deliver transparent reporting without building a custom data stack for each engagement.
              </p>
              <ul className="mt-4 text-sm text-slate-600 list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p className="mt-3 text-sm text-slate-600">
                Growth, finance, and ops leaders at venture-backed or profitable SMBs use GStack to align on the same numbers across time zones and tools.
              </p>
              <ul className="mt-4 text-sm text-slate-600 list-disc pl-6 space-y-1">
                ...
                <li>Integrate GStack API calls into internal tools and existing data warehouses.</li>
              </ul>
            </section>
          </div>
        </main>
