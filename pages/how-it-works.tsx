...
export default function Page() {
  return (
    <>
      <Head>
        <title>GotoDeck — How it works</title>
        <meta name="description" content="GotoDeck turns your growth data into actionable go-to-market decisions in three steps." />
      </Head>
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-3">
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <p className="mt-2 text-sm text-slate-600">Connect your traffic, revenue, and product data sources — or paste them in directly. GotoDeck ingests Shopify, Stripe, Plausible, PostHog, and any REST/JSON feed.</p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              <div className="text-sm font-bold text-indigo-600">Step 2</div>
              <h3 className="mt-1 font-semibold text-slate-900">Run</h3>
              <p className="mt-2 text-sm text-slate-600">GotoDeck normalises your metrics, segments channels by geography, and surfaces the signals that matter — from CAC payback to LTV cohorts.</p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-6">
