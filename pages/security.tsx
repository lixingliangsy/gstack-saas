...
export default function Page() {
  return (
    <>
      <Head>
        <title>GStack — Security & Compliance</title>
        <meta name="description" content="GStack security posture: GDPR, VAT, PCI-DSS, SOC 2, and data-residency commitments for cross-border SaaS teams." />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">GStack is designed for teams selling across jurisdictions without breaking the rules. Here is what we stand behind.</p>

          <section className="mt-10">
            <h2 className="text-xl font-semibold text-slate-900">Data protection</h2>
            <ul className="mt-4 space-y-3 text-sm text-slate-600">
              <li><strong className="text-slate-900">GDPR.</strong> GStack processes personal data only as your processor or on your behalf as controller. We provide a Data Processing Addendum (DPA) on request and support data export, correction, and erasure workflows.</li>
          ...
          <section className="mt-10">
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-600">
              ...
              <li><strong className="text-slate-900">VAT & sales tax.</strong> GStack is registered for VAT in the EU (VIES-validated) and collects VAT on applicable digital-service sales. US customers are not charged sales tax at this time.</li>
          ...
          <section className="mt-10">
            ...
            <p className="mt-3 text-sm text-slate-600">
              If you discover a security issue in GStack, please report it to <a className="text-indigo-600 hover:underline" href="mailto:security@gstack.io">security@gstack.io</a>. We acknowledge every report within 48 hours and aim to ship a fix or mitigation within 14 days for validated issues.
            </p>
          </section>
        </main>
